...
- **Course detail:** "About this course" copy, covered topics and "How you'll train" rows beside a sticky "At a glance" card (photo, duration, where, certification, accreditation logos, Join and Call pills); previous/next links; clients carousel where relevant; four related course cards.
